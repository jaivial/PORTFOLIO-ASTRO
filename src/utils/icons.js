...
export const getIcon = (tech) => {
    const icons = {
        ...
        typescript: {
            type: "svg",
            content: `<svg class="fill-primary" width="1.8rem" height="1.8rem" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="typescript">
        ...
        vscode: {
            type: "svg",
            content: `<svg class="fill-primary" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M23.15 2.587L18.21.21a1.494 1.494 0 0 0-1.705.29l-9.46 8.63-4.12-3.128a.999.999 0 0 0-1.276.057L.327 7.261A1 1 0 0 0 .326 8.74L3.899 12 .326 15.26a1 1 0 0 0 .001 1.479L1.65 17.94a.999.999 0 0 0 1.276.057l4.12-3.128 9.46 8.63a1.492 1.492 0 0 0 1.704.29l4.942-2.377A1.5 1.5 0 0 0 24 20.06V3.939a1.5 1.5 0 0 0-.85-1.352zm-5.146 14.861L10.826 12l7.178-5.448v10.896z"/>
      </svg>`,
        },
        figma: {
            type: "svg",
            content: `<svg class="fill-primary" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
        ...
        git: {
            type: "svg",
            content: `<svg class="fill-primary" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        // Local images (nuevos iconos) - ahora en CDN
        "next.js": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/nextjs-icon.svg",
            classes: "h-8 w-auto",
        },
        "tailwind css": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/tailwind-css-seeklogo.webp",
            classes: "h-8 w-auto",
        },
        "stripe": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/stripe.webp",
            classes: "h-8 w-auto brightness-200",
        },
        "shadcn ui": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/shadcnui.webp",
            classes: "h-8 w-auto brightness-150",
        },
        "seo": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/seo.webp",
            classes: "h-8 w-auto brightness-150",
        },
        "responsive design": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/responsivedesign.webp",
            classes: "h-8 w-auto brightness-150",
        },
        "paypal": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/paypal.webp",
            classes: "h-8 w-auto brightness-150",
        },
        "openai": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/openai.webp",
            classes: "h-8 w-auto brightness-150",
        },
        "nodemailer": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/nodemailer.webp",
            classes: "h-8 w-auto brightness-150",
        },
        "nextauth.js": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/nextauth.webp",
            classes: "h-8 w-auto brightness-150",
        },
        "next-intl": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/next-intl.svg",
            classes: "h-8 w-auto brightness-150",
        },
        "i18n": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/i18n.webp",
            classes: "h-8 w-auto brightness-150",
        },
        "framer motion": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/framermotion.svg",
            classes: "h-8 w-auto brightness-150",
        },
        "express js": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/expressjs.webp",
            classes: "h-8 w-auto brightness-150",
        },
        "vps": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/newlanguagesicons/vps.webp",
            classes: "h-8 w-auto brightness-150",
        },
        // External images (del language-icons.json)
        "react native": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/React-Native-Logo.png",
            classes: "h-8 w-auto brightness-[500]",
        },
        prisma: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/prismalogo.png",
            classes: "h-8 w-auto brightness-[500]",
        },
        nextjs: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/nextjs-logo.png",
            classes: "h-8 w-auto",
        },
        php: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/PHP-logo.svg.png",
            classes: "h-8 w-auto",
        },
        mongodb: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/mongodb-icon-1.svg",
            classes: "h-8 w-auto brightness-150",
        },
        mysql: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/mysql-logo.png",
            classes: "h-8 w-auto brightness-200",
        },
        postgresql: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/POSTGRESQL-LOGO.png",
            classes: "h-8 w-auto brightness-200",
        },
        go: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/go-logo.png",
            classes: "h-8 w-auto brightness-200",
        },
        flutter: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/flutter-logo.png",
            classes: "h-8 w-auto brightness-200",
        },
        vercel: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/logo-vercel-svgrepo-com.svg",
            classes: "h-8 w-auto",
        },
        netlify: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/netlify-original.svg",
            classes: "h-8 w-auto brightness-200",
        },
        postman: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/postman.svg",
            classes: "h-8 w-auto",
        },
        api: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/api-logo.png",
            classes: "h-8 w-auto brightness-200",
        },
        htmx: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/htmx-logo-png_seeklogo-554504.png",
            classes: "h-8 w-auto brightness-200",
        },
        remix: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/remix-letter-glowing.svg",
            classes: "h-8 w-auto brightness-200",
        },
        pm2: {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/pm2-logo-1-1.png",
            classes: "h-8 w-auto brightness-200",
        },
        // Hero Budget technologies - ahora en CDN
        "i18next": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/tecnologies/i18next.webp",
            classes: "h-8 w-auto brightness-[500]",
        },
        "jest": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/tecnologies/jest.svg",
            classes: "h-8 w-auto brightness-[500]",
        },
        "jotai": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/tecnologies/jotai.webp",
            classes: "h-8 w-auto",
        },
        "oauth 2.0": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/tecnologies/oauth2.webp",
            classes: "h-8 w-auto invert brightness-200",
        },
        "react navigation": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/tecnologies/react-navigation.svg",
            classes: "h-8 w-auto invert brightness-200",
        },
        "restful api": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/tecnologies/rest-api.svg",
            classes: "h-8 w-auto invert brightness-200",
        },
        "sqlite": {
            type: "img",
            src: "https://cdn.jaimedigitalstudio.com/assets/images/tecnologies/sqlite.svg",
            classes: "h-8 w-auto invert brightness-200",
        },
    };
