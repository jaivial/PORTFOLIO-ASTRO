...
export const getIcon = (tech) => {
    const icons = {
        ...
        "next.js": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/nextjs-icon.svg`,
            classes: "h-8 w-auto",
        },
        "tailwind css": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/tailwind-css-seeklogo.webp`,
            classes: "h-8 w-auto",
        },
        "stripe": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/stripe.webp`,
            classes: "h-8 w-auto brightness-200",
        },
        "shadcn ui": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/shadcnui.webp`,
            classes: "h-8 w-auto brightness-150",
        },
        "seo": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/seo.webp`,
            classes: "h-8 w-auto brightness-150",
        },
        "responsive design": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/responsivedesign.webp`,
            classes: "h-8 w-auto brightness-150",
        },
        "paypal": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/paypal.webp`,
            classes: "h-8 w-auto brightness-150",
        },
        "openai": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/openai.webp`,
            classes: "h-8 w-auto brightness-150",
        },
        "nodemailer": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/nodemailer.webp`,
            classes: "h-8 w-auto brightness-150",
        },
        "nextauth.js": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/nextauth.webp`,
            classes: "h-8 w-auto brightness-150",
        },
        "next-intl": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/next-intl.svg`,
            classes: "h-8 w-auto brightness-150",
        },
        "i18n": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/i18n.webp`,
            classes: "h-8 w-auto brightness-150",
        },
        "framer motion": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/framermotion.svg`,
            classes: "h-8 w-auto brightness-150",
        },
        "express js": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/expressjs.webp`,
            classes: "h-8 w-auto brightness-150",
        },
        "vps": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/newlanguagesicons/vps.webp`,
            classes: "h-8 w-auto brightness-150",
        },
        // External images (del language-icons.json)
        "react native": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/React-Native-Logo.png`,
            classes: "h-8 w-auto brightness-[500]",
        },
        prisma: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/prismalogo.png`,
            classes: "h-8 w-auto brightness-[500]",
        },
        nextjs: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/nextjs-logo.png`,
            classes: "h-8 w-auto",
        },
        php: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/PHP-logo.svg.png`,
            classes: "h-8 w-auto",
        },
        mongodb: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/mongodb-icon-1.svg`,
            classes: "h-8 w-auto brightness-150",
        },
        mysql: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/mysql-logo.png`,
            classes: "h-8 w-auto brightness-200",
        },
        postgresql: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/POSTGRESQL-LOGO.png`,
            classes: "h-8 w-auto brightness-200",
        },
        go: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/go-logo.png`,
            classes: "h-8 w-auto brightness-200",
        },
        flutter: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/flutter-logo.png`,
            classes: "h-8 w-auto brightness-200",
        },
        vercel: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/logo-vercel-svgrepo-com.svg`,
            classes: "h-8 w-auto",
        },
        netlify: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/netlify-original.svg`,
            classes: "h-8 w-auto brightness-200",
        },
        postman: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/postman.svg`,
            classes: "h-8 w-auto",
        },
        api: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/api-logo.png`,
            classes: "h-8 w-auto brightness-200",
        },
        htmx: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/htmx-logo-png_seeklogo-554504.png`,
            classes: "h-8 w-auto brightness-200",
        },
        remix: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/remix-letter-glowing.svg`,
            classes: "h-8 w-auto brightness-200",
        },
        pm2: {
            type: "img",
            src: `${__CDN_URL__}/assets/images/pm2-logo-1-1.png`,
            classes: "h-8 w-auto brightness-200",
        },
        // Hero Budget technologies - ahora en CDN
        "i18next": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/tecnologies/i18next.webp`,
            classes: "h-8 w-auto brightness-[500]",
        },
        "jest": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/tecnologies/jest.svg`,
            classes: "h-8 w-auto brightness-[500]",
        },
        "jotai": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/tecnologies/jotai.webp`,
            classes: "h-8 w-auto",
        },
        "oauth 2.0": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/tecnologies/oauth2.webp`,
            classes: "h-8 w-auto invert brightness-200",
        },
        "react navigation": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/tecnologies/react-navigation.svg`,
            classes: "h-8 w-auto invert brightness-200",
        },
        "restful api": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/tecnologies/rest-api.svg`,
            classes: "h-8 w-auto invert brightness-200",
        },
        "sqlite": {
            type: "img",
            src: `${__CDN_URL__}/assets/images/tecnologies/sqlite.svg`,
            classes: "h-8 w-auto invert brightness-200",
        },
    };
