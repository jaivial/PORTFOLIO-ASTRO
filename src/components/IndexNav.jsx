          ...
          <div className="fixed right-[-10px] top-[50%] rotate-[270deg]">
            <div className="">
              <div className="w-full">
                ...
                >
                  {show ? (
                    <svg className="h-4" height="1em" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={` animate-menu -z-10 top-[0px] left-[0px]  fixed bg-primary  h-[100%] custom w-[100%]`}>
              <div className=" h-[100%] custom w-[100%] flex items-center justify-center">
                <ul className="flex flex-col text-4xl font-bold text-center space-y-10">
                  ...
                  <a onClick={() => isShow(false)} aria-label="projects" href="/projects">
                    Proyectos
                  </a>
                  <a onClick={() => isShow(false)} aria-label="about" href="/#about">
                    Sobre Mi
                  </a>
                  <a onClick={() => isShow(false)} aria-label="contact" href="/#contact">
                    Contacto
                  </a>
                </ul>
              </div>
