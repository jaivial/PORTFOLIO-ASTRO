...
function About() {
  ...
  return (
    <section id="about" className="w-5/6 mx-auto m-6">
      <div className="gap-8 py-8 px-4 mx-auto">
        <div className="mt-4 md:mt-0">
          <h2 
            data-aos="fade-up" 
            data-aos-anchor-placement="center-bottom" 
            className="mb-4 text-4xl tracking-tight font-extrabold text-primary text-transparent bg-clip-text bg-gradient-to-r from-[#d7d7d7] to-[#616161] sm:text-3xl md:text-5xl pb-2 text-center"
          >
            {t('about.title')}
          </h2>
          <p 
            data-aos="fade-up" 
            data-aos-anchor-placement="center-bottom" 
            className="mb-6 font-light text-gray-200 md:text-xl text-justify dark:text-gray-200 sm:text-center sm:w-5/6 w-full mx-auto"
          >
            <span>{t('about.description_p1')}</span>
            <br /><br />
            <span>{t('about.description_p2')}</span>
            <br /><br />
            <span>{t('about.description_p3')}</span>
          </p>
        </div>
        <section className="py-0 sm:py-10">
          <div className="container mx-auto">
            <div data-aos="fade-up" data-aos-anchor-placement="top-bottom">
              ...
              <div className="grayscale opacity-75 grid grid-cols-2 sm:flex sm:flex-wrap gap-8 w-full justify-center">
                <div className="flex flex-row items-center gap-4">
                  <svg className="fill-primary h-12 w-12" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
                  ...
                  <p className="mt-2 text-sm text-gray-200 text-center">JavaScript</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <svg className="fill-primary h-12 w-12" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" id="typescript">
                  ...
                  <p className="mt-2 text-sm text-gray-200 text-center">TypeScript</p>
                </div>

                <div className="flex flex-row items-center gap-4">
                  <svg className="fill-primary h-12" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
                    <title>Nodejs</title>
                  ...
                  <p className="mt-2 text-sm text-gray-200 text-center">Node.js</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <svg className="fill-primary h-12" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512">
                    <title>CSS</title>
                  ...
                  <p className="mt-2 text-sm text-gray-200 text-center">CSS</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <svg className="fill-primary h-12" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                ...
                <div className="flex flex-row items-center">
                  <img src={`${__CDN_URL__}/assets/images/React-Native-Logo.png`} alt="React Native" className="fill-primary h-[3.5rem] mr-2 brightness-[500]"  loading="lazy" decoding="async" />
                  <p className="mt-0 text-sm text-gray-200 text-center">React Native</p>
                </div>
                <div className="flex flex-row items-center">
                  <img src={`${__CDN_URL__}/assets/images/prismalogo.png`} alt="Prisma" className="fill-primary h-[3.5rem] mr-2 brightness-[500]"  loading="lazy" decoding="async" />
                  <p className="mt-0 text-sm text-gray-200 text-center">Prisma</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <svg className="fill-primary h-12" fill="#000000" height="1em" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve">
                  ...
                  <p className="mt-2 text-sm text-gray-200 text-center">Tailwind</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <svg className="fill-primary h-12" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512">
                    <title>Html</title>
                  ...
                  <p className="mt-2 text-sm text-gray-200 text-center">HTML</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <svg className="fill-primary h-12 brightness-[500]" height="1em" viewBox="0 0 32.00 32.00" xmlns="http://www.w3.org/2000/svg" fill="#000000" stroke="#000000" strokeWidth="0.00032" transform="matrix(1, 0, 0, 1, 0, 0)">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier">
                      <title>Astro.js</title><path
                        ...
                        style={{fillRule:'evenodd'}}></path>
                    </g>
                  </svg>
                  <p className="mt-2 text-sm text-gray-200 text-center">Astro</p>
                </div>

                <div className="flex flex-row items-center">
                  <img src={`${__CDN_URL__}/assets/images/nextjs-logo.png`} alt="Next.js" className="fill-primary h-16 mr-2"  loading="lazy" decoding="async" />
                  <p className="mt-0 text-sm text-gray-200 text-center">Next.js</p>
                </div>

                <div className="flex flex-row items-center">
                  <img src={`${__CDN_URL__}/assets/images/PHP-logo.svg.png`} alt="PHP" className="fill-primary h-12 mr-2"  loading="lazy" decoding="async" />
                  <p className="mt-0 text-sm text-gray-200 text-center">PHP</p>
                </div>

                <div className="flex flex-row items-center">
                  <img src={`${__CDN_URL__}/assets/images/mongodb-icon-1.svg`} alt="MongoDB" className="fill-primary h-16 brightness-150"  loading="lazy" decoding="async" />
                  <p className="mt-0 text-sm text-gray-200 text-center">MongoDB</p>
                </div>

                <div className="flex flex-row items-center">
                  <img src={`${__CDN_URL__}/assets/images/mysql-logo.png`} alt="MySQL" className="fill-primary h-[5rem] mr-2 brightness-200"  loading="lazy" decoding="async" />
                  <p className="mt-0 text-sm text-gray-200 text-center">MySQL</p>
                </div>
                <div className="flex flex-row items-center">
                  <img src={`${__CDN_URL__}/assets/images/go-logo.png`} alt="GO" className="fill-primary h-[3rem] mr-2 brightness-200"  loading="lazy" decoding="async" />
                  <p className="mt-0 text-sm text-gray-200 text-center">GO</p>
                </div>

                <div className="flex flex-row items-center">
                  <img src={`${__CDN_URL__}/assets/images/POSTGRESQL-LOGO.png`} alt="PostgreSQL" className="fill-primary h-[3.5rem] mr-2 brightness-200"  loading="lazy" decoding="async" />
                  <p className="mt-0 text-sm text-gray-200 text-center">PostgreSQL</p>
                </div>
                <div className="flex flex-row items-center">
                  <img src={`${__CDN_URL__}/assets/images/flutter-logo.png`} alt="Flutter" className="fill-primary h-[3.5rem] mr-2 brightness-200"  loading="lazy" decoding="async" />
                  <p className="mt-0 text-sm text-gray-200 text-center">Flutter</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <svg className="fill-primary h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier">
                      <title>VS Code</title>
                      <path d="M0.228341 8.36915C0.228341 8.36915 -0.356212 7.94324 0.345251 7.37453L1.97956 5.89736C1.97956 5.89736 2.44721 5.40004 2.94164 5.83334L18.0231 17.375V22.9094C18.0231 22.9094 18.0158 23.7785 16.9124 23.6825L0.228341 8.36915Z"></path>
                      <path d="M4.11555 11.9367L0.228273 15.5089C0.228273 15.5089 -0.171172 15.8093 0.228273 16.346L2.03308 18.0053C2.03308 18.0053 2.46175 18.4706 3.09502 17.9413L7.21611 14.7827L4.11555 11.9367Z"></path>
                      <path d="M10.94 11.9661L18.0691 6.46362L18.0228 0.95865C18.0228 0.95865 17.7183 -0.242793 16.7027 0.382548L7.21589 9.11025L10.94 11.9661Z"></path>
                      <path
                  ...
                  <p className="mt-2 text-sm text-gray-200 text-center">VS Code</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <svg className="fill-primary h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier">
                      ...
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M8.66699 9.41667C7.24021 9.41667 6.08366 10.5731 6.08366 11.9998C6.08366 13.4266 7.24026 14.5832 8.66699 14.5832H11.2503V12.0519C11.2501 12.0346 11.25 12.0172 11.25 11.9998C11.2501 11.9825 11.2503 11.9651 11.2503 11.9478V9.41667ZM11.2503 7.91667H8.66699C7.24026 7.91667 6.08366 6.76007 6.08366 5.33333C6.08366 3.9066 7.24026 2.75 8.66699 2.75H11.2503V7.91667ZM12.7503 2.75V7.91663L15.333 7.9165C16.7597 7.9165 17.9167 6.76002 17.9167 5.33333C17.9167 3.9066 16.7601 2.75 15.3333 2.75H12.7503ZM15.3331 9.4165C13.9203 9.41664 12.7724 10.5509 12.7503 11.9584V12.0412C12.7724 13.4489 13.9204 14.5832 15.3333 14.5832C16.7601 14.5832 17.9167 13.4266 17.9167 11.9998C17.9167 10.5731 16.7598 9.41652 15.3331 9.4165ZM8.66699 16.0832C7.2403 16.0832 6.0835 17.24 6.0835 18.6668C6.0835 20.0936 7.24009 21.2502 8.66683 21.2502C10.0936 21.2502 11.2502 20.0936 11.2502 18.6668L11.2503 16.0832H8.66699Z"
                      ></path>
                    </g>
                  </svg>
                ...
                <div className="flex flex-row items-center gap-4">
                  <img src={`${__CDN_URL__}/assets/images/logo-vercel-svgrepo-com.svg`} alt="Vercel" className="fill-primary h-12 text-primary"  loading="lazy" decoding="async" />
                  <p className="mt-2 text-sm text-gray-200 text-center">Vercel</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <img src={`${__CDN_URL__}/assets/images/netlify-original.svg`} alt="Vercel" className="fill-primary h-12 text-primary brightness-200"  loading="lazy" decoding="async" />
                  <p className="mt-2 text-sm text-gray-200 text-center">Netlify</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <img src={`${__CDN_URL__}/assets/images/postman.svg`} alt="Postman" className="fill-primary h-14"  loading="lazy" decoding="async" />
                  <p className="mt-2 text-sm text-gray-200 text-center">Postman</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <img src={`${__CDN_URL__}/assets/images/api-logo.png`} alt="API" className="h-16 fill-primary brightness-200"  loading="lazy" decoding="async" />
                  <p className="mt-2 text-sm text-gray-200 text-center">API</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <img src={`${__CDN_URL__}/assets/images/htmx-logo-png_seeklogo-554504.png`} alt="HTMX" className="fill-primary h-14 brightness-200"  loading="lazy" decoding="async" />
                  <p className="mt-2 text-sm text-gray-200 text-center">HTMX</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <img src={`${__CDN_URL__}/assets/images/remix-letter-glowing.svg`} alt="REMIX" className="fill-primary h-14 brightness-200"  loading="lazy" decoding="async" />
                  <p className="mt-2 text-sm text-gray-200 text-center">REMIX</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <img src={`${__CDN_URL__}/assets/images/pm2-logo-1-1.png`} alt="PM2" className="fill-primary h-14 brightness-200"  loading="lazy" decoding="async" />
                  <p className="mt-2 text-sm text-gray-200 text-center">PM2</p>
                </div>
                <div className="flex flex-row items-center gap-4">
                  <svg className="fill-primary h-12 brightness-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <title>NGINX</title>
                  ...
                  <p className="mt-2 text-sm text-gray-200 text-center">NGINX</p>
                </div>
              </div>
            </div>
          </div>
