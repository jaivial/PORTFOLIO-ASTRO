    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        ...
        <Image
          ...
          src={`${window.location.origin}/profilephoto.png`}
        />
      </View>
